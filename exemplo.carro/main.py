...
if __name__ == "__main__":
    ...
    '''
    while carro1.get_odometro() < 600 and carro2.get_odometro() < 600 or carro1.get_tanque() > 0 and carro2.get_tanque() > 0:
        try:
          op = 0
          while op not in (1,2):
              op = int(input("Qual carro que você deseja operar: "))
          if op == 1:
              operar_carro(carro1)
          else:
              operar_carro(carro2)
